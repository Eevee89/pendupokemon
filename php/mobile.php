    ...
    <div id="accountModal" class="modal">
        <div class="modal-content">
            ...
            <form action="" method="POST">
                ...
                <input name="password" id="chpassword" type="password" placeholder="Entrez nouv. mot de passe (max. 15)">
                <input name="cpassword" id="chcpassword" type="password" placeholder="Confirmez nouv. mot de passe (max. 15)">
                <div style="display: flex; justify-content: center; width: 100%;">
